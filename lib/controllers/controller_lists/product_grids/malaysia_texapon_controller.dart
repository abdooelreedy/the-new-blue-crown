...
class MalaysiaTexaponController extends GetxController{
  final MalaysiaTexaponRepo malaysiaTexaponRepo;

  MalaysiaTexaponController({required this.malaysiaTexaponRepo});

  List<ProductModel> _malaysiaTexaponList = [];
  List<ProductModel> get malaysiaTexaponList => _malaysiaTexaponList;
  ...
  Future<void> getMalaysiaTexaponList() async {
    Response response = await malaysiaTexaponRepo.getMalaysiaTexaponList();
    if(response.statusCode == 200) {
      _malaysiaTexaponList = [];
      _malaysiaTexaponList.addAll(Product.fromJson(response.body).products);
      _isLoaded = true;
      update();
    }else{
