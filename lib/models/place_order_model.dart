...
class PlaceOrderBody {
  ...
  PlaceOrderBody(
      {
        ...
        required int totalAmountInCart,
    ...
    this._cart = cart;
    this._totalAmountInCart = totalAmountInCart;
  ...
  int get totalAmountInCart => _totalAmountInCart;
  ...
  PlaceOrderBody.fromJson(Map<String, dynamic> json) {
    ...
    _totalAmountInCart = json['totalAmountInCart'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['totalAmountInCart'] = this._totalAmountInCart;
