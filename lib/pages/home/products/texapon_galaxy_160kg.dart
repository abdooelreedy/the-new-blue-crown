...
class Texapon_Galaxy_160kg extends StatelessWidget {
  ...
  const Texapon_Galaxy_160kg({
    Key? key,
    this.emptyValue = "7.30",
    this.netValue = "160",
    this.fullValue = "167.30",
    this.origin = "Egypt",
    this.type = "Gel",
    this.company = "Galaxy",
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/products/texapon_galaxy_160kg.png',),
