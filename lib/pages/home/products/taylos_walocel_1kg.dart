...
class Taylos_Walocel_1kg extends StatelessWidget {
  ...
  const Taylos_Walocel_1kg({
    Key? key,
    this.emptyValue = "0.021",
    this.netValue = "1",
    this.fullValue = "1.021",
    this.origin = "Germany",
    this.type = "Powder",
    this.company = "Walocel",
    this.concentration = "40 thousand",
    this.pro = "2022",
    this.exp = "2_year",
    this.price = "220.00",
    this.name = "Taylos_Walocel",
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/products/taylos_walocel_1kg.png',),
