...
class Semasol_Dow_1kg extends StatelessWidget {
  ...
  const Semasol_Dow_1kg({
    Key? key,
    this.emptyValue = "70 جم",
    this.netValue = "1 كجم",
    this.fullValue = "1.07 كجم",
    this.origin = "أمريكا",
    this.type = "سائل لزج",
    this.company = "DOW",
    this.concentration = "",
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/products/semasol_dow_1kg.png',),
