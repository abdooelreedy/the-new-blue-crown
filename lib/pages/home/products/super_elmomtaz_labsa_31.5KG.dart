...
class Super_Elmomtaz_Labsa_31KG extends StatelessWidget {
  ...
  const Super_Elmomtaz_Labsa_31KG({
    Key? key,
    this.emptyValue = "1.5",
    this.netValue = "31.5",
    this.fullValue = "33",
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/products/super_elmomtaz_labsa_31.5KG.png',),
