...
class Elmomtaz_Labsa_31KG extends StatelessWidget {
  ...
  const Elmomtaz_Labsa_31KG({
    ...
    this.type = "Liquid",
    this.company = "Loloaa",
    this.concentration = "75 %",
    this.pro = "2022",
    this.exp = "3_year",
    this.price = "1,225",
    this.name = "ElMomtaz_Labsa",
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('assets/products/elmomtaz_labsa_31.5KG.png',),
