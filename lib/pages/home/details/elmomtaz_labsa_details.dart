...
//
//
// class ElMomtazLabsaDetails extends StatefulWidget {
//   final int pageId ;
//   final String page;
//   var image;
//
//   ElMomtazLabsaDetails({
//     Key? key,
...
//
//   @override
//   State<ElMomtazLabsaDetails> createState() => _ElMomtazLabsaDetailsState();
//
// }
//
// class _ElMomtazLabsaDetailsState extends State<ElMomtazLabsaDetails> with TickerProviderStateMixin{
//
...
//
//                                             value:
//                                             elMomtazLabsa.inCartItems <= product.quantity2! ?
//                                             product.price.toString() + " " + "Pound".tr : elMomtazLabsa.inCartItems >= product.quantity2! && elMomtazLabsa.inCartItems <= product.quantity3! ?
//                                             product.price2.toString() + " " + "Pound".tr : elMomtazLabsa.inCartItems >= product.quantity3! && elMomtazLabsa.inCartItems <= product.quantity4! ?
//                                             product.price3.toString() + " " + "Pound".tr : product.price4.toString() + " " + "Pound".tr,
//
//                                             color: elMomtazLabsa.inCartItems <= product.quantity2! ? Colors.blue : Colors.red,
...
//                     child: cartController.existInCart(product) && elMomtazLabsa.checkQuantity(-1) == 0 || elMomtazLabsa.inCartItems.toString() == "0" ?
//                     ElevatedButton(
//                       onPressed: () {
//                         elMomtazLabsa.increase(product);
...
//                           InkWell(
//                             onTap: (){
//                               elMomtazLabsa.decrease(product);
//                               elMomtazLabsa.addItem(product);
//                             },
//                             child: Container(
//                               width: Dimensions.width30 * 2,
