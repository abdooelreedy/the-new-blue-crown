...
//
// class MalaysiaTexponDetails extends StatefulWidget {
//
//   final int pageId ;
//   final String page;
//
//   const MalaysiaTexponDetails({
//     Key? key,
...
//
//   @override
//   State<MalaysiaTexponDetails> createState() => _MalaysiaTexponDetailsState();
// }
//
// class _MalaysiaTexponDetailsState extends State<MalaysiaTexponDetails> with TickerProviderStateMixin {
//
...
//
//     var product = Get.find<MalaysiaTexaponController>().malaysiaTexaponList[widget.pageId];
...
//                                       imageUrl: AppConstants.BASE_URL + AppConstants.UPLOAD_URL + malaysiaTexapon.malaysiaTexaponList[widget.pageId].img!,
...
//                                   child: Badge(
//                                     badgeContent: Text(
//                                       malaysiaTexapon.inCartItems.toString(),
//                                       style: TextStyle(
//                                           color: Colors.white,
...
//                                     showBadge: malaysiaTexapon.inCartItems.toString() == "0" ? false : true,
...
//
//                                               color: malaysiaTexapon.inCartItems <= product.quantity2! ? Colors.blue : Colors.red,
...
//                           child: CustomBigText(
//                             text: malaysiaTexapon.inCartItems.toString(),
//                           ),
//                         ),
//                       ),
//
